...
console.log("Chega chato pra caranba!!!");
...
const bandas = [
    "Sleyer", "Pink Floyd", "Rush", "Nightwish",
...
/* Exercícios
1) Faça um array chamado "clientes" contendo 3 objeto deverá ter uma propriedade "identificador" (com valores 1, 2 e 3) e uma propriedade "nome" (com os nomes dos clientes: "Goku", "Naruto" e "Shiryu").
